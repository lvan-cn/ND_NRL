...
class DataSet():
    ...
    def reader_arnetminer(self):
        ...
        for idx1 in xrange(0, len(self.paper_list) - 1):
            self.D_Graph.add_node(self.paper_list[idx1])
            for idx2 in xrange(idx1 + 1, len(self.paper_list)):
                self.D_Graph.add_node(self.paper_list[idx2])
                ...
                if edge_weight != 0:
                    self.D_Graph.add_edge(self.paper_list[idx1], self.paper_list[idx2], weight=edge_weight)
